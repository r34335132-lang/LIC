...
import { Users, Search, Plus, MoreHorizontal, Eye, Edit, UserX } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground md:text-3xl">Gestión de Alumnos</h1>
